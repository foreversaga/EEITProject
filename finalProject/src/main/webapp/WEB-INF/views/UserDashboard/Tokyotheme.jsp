...
<body>
	...
	<div class="hero-wrap js-fullheight"
		style="background-image: url(<c:url value='/img/Tokyo-FUJI.jpg'/>);">
			...
			<div
				...
				<div class="col-md-9 ftco-animate"
					...
					<h1 class="mb-4 justify-content-center"
						...
						<strong style="text-align: center;">東京<br></strong>
					</h1>
			...
			<div class="row d-flex">
				...
				<div class="col-md-4 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services d-block text-center">
						...
						<div class="media-body p-2 mt-2">
							<h3 class="heading mb-4">經典地標</h3>
							<p>淺草寺、明治神宮、千鳥淵、東京鐵塔等地標，新舊並存的樣貌每年旅客絡繹不絕</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services d-block text-center">
						...
						<div class="media-body p-2 mt-2">
							<h3 class="heading mb-4">熱門主題樂園</h3>
							<p>東京迪士尼樂園、富士急樂園、世嘉都市樂園，帶您重返童年美夢。</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row justify-content-start">
				<div class="col-md-5 heading-section ftco-animate">
					...
					<h5>全世界最著名的現代大都會，每年有超過一千萬旅客到訪，其新舊並存的風情吸引更多人朝聖。</h5>
					<h5>只要一天的時間，就足夠你從最古老的寺院穿越到最摩登的大廈。一定要參觀淺草寺，它是歷史最悠久、規模最大的佛寺。如果想看東京全景就登上晴空塔。不容錯過的還有最夢幻的迪士尼樂園和全球獨家的東京迪士尼海洋！</h5>
				...
				<div class="col-md-6 heading-section ftco-animate">
					...
					<div class=" ">
						<a class="weatherwidget-io "
							href="https://forecast7.com/zh-tw/35d69139d69/tokyo/"
							data-label_1="東京" data-font="微軟正黑體 (Microsoft JhengHei)"
							data-theme="original">東京</a>
					</div>
					<div class="row justify-content-start">
						<div class="col-md-6">
	...
	<section class="ftco-section bg-light "
		...
		<div class="container-fluid">
			<div class="row ">
				<c:forEach varStatus="vs" var="tokyoproduct" items="${productList}"
					begin="8" end="12">
					<div class="col-sm col-md-6 col-lg ftco-animate container">
						<div class="destination">
							<a href="<c:url value='/ProductSingle/${tokyoproduct.pId}'/>"
								class="img img-2 d-flex justify-content-center align-items-center"
								style="background-image: url(<c:url value='/showPic/${tokyoproduct.pId}'/>);">
								...
								<div class="d-flex">
									<div class="one">
										<h3 style="height: 80px;">
											<a href="<c:url value='/ProductSingle/${productBean.pId}'/>">${tokyoproduct.pName}</a>
										</h3>
										<p class="rate">
											<c:choose>
												<c:when
													test="${tokyoproduct.pAvgRating>=1&&tokyoproduct.pAvgRating<2 }">
													<i class="icon-star"></i>
												...
												<c:when
													test="${tokyoproduct.pAvgRating>=2&&tokyoproduct.pAvgRating<3 }">
													<i class="icon-star"></i>
													<i class="icon-star"></i>
													<i class="icon-star-o"></i>
													<i class="icon-star-o"></i>
												...
												<c:when
													test="${tokyoproduct.pAvgRating>=3&&tokyoproduct.pAvgRating<4 }">
													<i class="icon-star"></i>
													<i class="icon-star"></i>
													<i class="icon-star"></i>
													<i class="icon-star-o"></i>
												...
												<c:when
													test="${tokyoproduct.pAvgRating>=4&&tokyoproduct.pAvgRating<5 }">
													<i class="icon-star"></i>
													<i class="icon-star"></i>
													<i class="icon-star"></i>
													<i class="icon-star"></i>
											...
											<span>${tokyoproduct.pAvgRating}</span>
										</p>
									</div>
									<div class="two">
										<span class="price per-price">$${tokyoproduct.pPrice}<br></span>
									</div>
								</div>
								<p style="height: 180px;">${tokyoproduct.pContent}</p>
								<hr>
								<p class="bottom-area d-flex">
									<a class="btn btn-outline-info"
										href="<c:url value='/ProductSingle/${tokyoproduct.pId}'/>">詳細資訊</a>
								</p>
							</div>
						</div>
					</div>
